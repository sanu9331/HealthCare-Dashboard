...
const Header = () => {
  return (
    <header className="flex w-full">
      ...
      <div className="w-64 bg-blue-50 px-6 py-6 -mt-10 pt-16 flex items-center justify-center">
        <span className="text-2xl font-bold text-cyan-400">Health</span>
        <span className="text-2xl font-bold text-violet-950">care.</span>
      </div>

      {/* Part 2 - Search section (left main content area) */}
      <div className="flex-[1.03] bg-white px-9 py-4 flex items-center">
      ...
      <div className="flex-1 bg-blue-50 px-6 py-4 flex items-center justify-end pr-16 -mt-10 pt-16">
